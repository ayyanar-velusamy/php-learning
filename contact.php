...
<form action="form.php" method="POST">
    ...
    <!--GENDER-->
    <p><label for="gender">gender</label><input type="radio" name="gender" id="gender" value="male" checked>male <input type="radio" name="gender" id="gender" value="female">female</p>
    <!--MAIL-->
